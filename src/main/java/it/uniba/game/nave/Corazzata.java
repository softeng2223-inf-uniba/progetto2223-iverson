...
/**
 * {@literal <<Entity>>} Classe che estende la classe Nave e rappresenta un particolare tipo di nave
 * caratterizzato dalla dimensione di 2 caselle nella mappa di gioco.
 */
