...
È possibile effettuare test automatici e operare dei controlli statici sulla qualità del codice Java (QA, quality assurance), grazie a strumenti come *JUnit*, *PMD*, *Checkstyle* e *Spotbugs*. Per lanciarli in un colpo solo si può utilizzare *Gradle*.
<!--
